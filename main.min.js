async function createMap() {
  ...
  const {
      YMap: e,
      YMapDefaultSchemeLayer: t,
      YMapDefaultFeaturesLayer: n,
      YMapMarker: i,
      YMapControls: o,
      YMapControlButton: r,
    } = ymaps3,
    { YMapZoomControl: s, YMapGeolocationControl: a } = await ymaps3.import(
      "@yandex/ymaps3-controls@0.0.1"
    ),
    l = new e(
      document.getElementById("map"),
      {
        location: { center: [28.5954, 52.2054], zoom: 16 },
        showScaleInCopyrights: !0,
      },
      [new t({}), new n({})]
    ),
  ...
  (d.className = "map-marker"),
    (d.src = "./img/yandex-icon.png"),
    (d.title = "Изготовление и ремонт РВД."),
    l.addChild(new i({ coordinates: [28.5954, 52.2054] })),
    l.addChild(new i({ coordinates: [28.5954, 52.2054] }, d)),
    l.addChild(new o({ position: "right" }).addChild(new s({}))),
    l.addChild(new o({ position: "top left" }).addChild(new a({})));
  const u = new o({ position: "bottom left" }),
    { YMapOpenMapsButton: p } = await ymaps3.import(
      "@yandex/ymaps3-controls-extra"
    ),
    f = new p({});
  u.addChild(f), l.addChild(u);
  const h = document.createElement("div");
  h.className = "fullscreen";
  const v = document.getElementById("map");
  document.addEventListener("fullscreenchange", function () {
    h.classList.toggle("exit-fullscreen"), v.classList.toggle("fullscreen-map");
  });
  const g = new r({
    element: h,
    onClick: function () {
      document.fullscreenElement
        ...
        : l.container.requestFullscreen();
    },
  });
  l.addChild(new o({ position: "top right" }).addChild(g));
}
!(function (e, t) {
  "use strict";
  ...
  var k = (function (e) {
    ...
    try {
      H.apply((L = O.call(x.childNodes)), x.childNodes),
            ...
            (g = $(
              ...
              (d = function (e, t, n, s, d) {
                ...
                for (
                  ...
                  if (l && u) {
                    for (
                      h = 0, t || u.ownerDocument == f || (p(u), (n = !v));
                      (g = o[h++]);
                ...
                if (((y += m), a && m !== y)) {
                  ...
                  if (e) {
                    if (0 < y) for (; m--; ) w[m] || b[m] || (b[m] = j.call(s));
                    b = Te(b);
                  }
                  H.apply(s, b),
                    d &&
  ...
  (x.filter = function (e, t, n) {
    ...
    x.fn.extend({
      ...
      is: function (e) {
        return !!D(this, "string" == typeof e && $.test(e) ? x(e) : e || [], !1)
          .length;
      },
    });
  var L,
  ...
  function we(e, t, n, i, o) {
    ...
    for (u.textContent = "", f = 0; (r = p[f++]); )
      if (i && -1 < x.inArray(r, i)) o && o.push(r);
        ...
        ((c = oe(r)), (s = ge(u.appendChild(r), "script")), c && ye(s), n)
      )
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && A(t, "input") && Ae(t, "click", ke),
            !1
          );
        },
        trigger: function (e) {
  ...
  function qe(e, t, n, i) {
    ...
    var o,
      ...
      g = t[0],
      y = h(g);
    if (y || (1 < p && "string" == typeof g && !f.checkClone && De.test(g)))
    ...
    if (
      ...
      for (l = (a = x.map(ge(o, "script"), Ne)).length; u < p; u++)
        (c = o),
          u !== v &&
          ...
          (c = a[u]),
            he.test(c.type || "") &&
              ...
              (c.src && "module" !== (c.type || "").toLowerCase()
                ...
                : m(c.textContent.replace(Le, ""), c, d));
    }
    return e;
  }
  function Pe(e, t, n) {
    for (var i, o = t ? x.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || x.cleanData(ge(i)),
        i.parentNode &&
          (n && oe(i) && ye(ge(i, "script")), i.parentNode.removeChild(i));
    return e;
  }
  x.extend({
    ...
    x.fn.extend({
      ...
      hasClass: function (e) {
        var t,
          ...
          i = 0;
        for (t = " " + e + " "; (n = this[i++]); )
          if (1 === n.nodeType && -1 < (" " + gt(yt(n)) + " ").indexOf(t))
            return !0;
        return !1;
      },
    });
  ...
  x.extend(x.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        3 !== i.nodeType &&
          8 !== i.nodeType &&
          !bt.test(m + x.event.triggered) &&
          (-1 < m.indexOf(".") && ((m = (w = m.split(".")).shift()), w.sort()),
          (c = m.indexOf(":") < 0 && "on" + m),
          ((t = t[x.expando]
            ? t
        ...
        if (!o && !p.noBubble && !v(i)) {
          for (
            l = p.delegateType || m, bt.test(l + m) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            y.push(s), (a = s);
        ...
        return (
          ...
          o ||
            ...
            (c &&
              ...
              ((a = i[c]) && (i[c] = null),
              (x.event.triggered = m),
              t.isPropagationStopped() && f.addEventListener(m, xt),
              i[m](),
              t.isPropagationStopped() && f.removeEventListener(m, xt),
  ...
  x.ajaxSetup({
    ...
    x.each(["top", "left"], function (e, t) {
      x.cssHooks[t] = Fe(f.pixelPosition, function (e, n) {
        if (n)
          return (n = We(e, t)), Me.test(n) ? x(e).position()[t] + "px" : n;
      });
    }),
  ...
  $(document).ready(function () {
    $(".production__slider").slick({ slidesToShow: 2, slidesToScroll: 1 }),
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelector(".loc__qr").addEventListener("click", () => {
      document.querySelector(".popup-qr").classList.remove("hide");
    }),
      document.querySelector(".popup-qr").addEventListener("click", (e) => {
        console.log(e.target.classList),
          e.target.classList.contains("popup-qr") &&
            document.querySelector(".popup-qr").classList.add("hide");
      }),
      e(".services .services__list-item", ".services .services__item"),
      e(".services-two .services__list-item", ".services-two .services__item"),
      document.querySelectorAll(".scroll-animation").forEach((e) => {
      ...
      document.querySelectorAll(".scroll-animation-start").forEach((e) => {
        e.classList.add("active");
      });
  }),
  (window.map = null),
